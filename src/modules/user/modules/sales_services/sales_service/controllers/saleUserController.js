...
const {
  registerMovement,
} = require("../../../../../../core/utils/movementUtils");
...
/**
 * @desc Crear una nueva venta (ERP + sincronización con E-commerce)
...
exports.createSale = async (req, res) => {
  ...
  try {
    await session.withTransaction(async () => {
      ...
      /* ────────────────────────────────
       * 🧩 Cliente (venta rápida o registrado)
       * ──────────────────────────────── */
      ...
      /* ────────────────────────────────
       * 💰 Totales e impuestos (IGV incluido)
       * ──────────────────────────────── */
